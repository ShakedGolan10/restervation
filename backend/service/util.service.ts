...
import { QueryReturnType } from "../models/query_model.service";
import { Restaurants } from "../models/restaurants";
import { Slots, SlotTable } from "../models/slots"
...
function createEmptySlots(shiftDuration: number, numOfDays: number, tables: SlotTable[], restId: Ref<Restaurants>, startHour: number, endHour: number) {
...
export function buildEmptySlotsForDuration(rest: QueryReturnType<typeof Restaurants>, duration: number, slotsTables: SlotTable[]):Slots[] {
  ...
  const emptySlots = createEmptySlots(shiftDuration, duration, slotsTables, _id, startHour, endHour)
